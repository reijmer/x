...
#line 94 "parser.y"
                                { (yyval.stmt) = new VariableDeclaration(*(yyvsp[-2].ident), (yyvsp[0].expr)); }
#line 1399 "parser.cpp"
    break;

  case 20: /* var_decl: ident  */
#line 95 "parser.y"
                    { (yyval.stmt) = new VariableDeclaration(*(yyvsp[0].ident));}
...
#line 99 "parser.y"
                                               { (yyval.stmt) = new IfStatement((yyvsp[-5].expr), (yyvsp[-3].block), (yyvsp[0].block)); }
#line 1417 "parser.cpp"
    break;

  case 23: /* func_decl: DEF ident LPAREN decl_args RPAREN COLON block  */
#line 102 "parser.y"
                                                            { (yyval.stmt) = new FunctionDeclaration(*(yyvsp[-5].ident), *(yyvsp[-3].varvec), *(yyvsp[0].block)); delete (yyvsp[-3].varvec); }
...
#line 117 "parser.y"
                                     { (yyval.stmt) = new WhileLoop((yyvsp[-2].expr), (yyvsp[0].block)); }
#line 1471 "parser.cpp"
    break;

  case 32: /* while_loop: WHILE expr COLON block ELSE COLON block  */
#line 118 "parser.y"
                                                      { (yyval.stmt) = new WhileLoop((yyvsp[-5].expr), (yyvsp[-3].block), (yyvsp[0].block)); }
...
#line 127 "parser.y"
                            { (yyval.expr) = new BooleanOperator(*(yyvsp[-2].expr), (yyvsp[-1].token), *(yyvsp[0].expr)); }
